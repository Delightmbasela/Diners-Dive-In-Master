...
<head>
    ...
    <title>Diners-Dive-In: Restaurant Reservation Form</title>
</head>
<body>
...
<form method="post" action="reservation_database.php">
  <!--  General -->
  ...
  <div class="form-group">
    ...
    <div class="controls">
      ...
      <select class="floatLabel">
        ...
        <option value="Fives">Five</option>
    ...
    <div class="controls">
      ...
      <div class="grid">
        <p class="info-text">Please describe your extra needs below</p>
        <br>
        <div class="controls">
